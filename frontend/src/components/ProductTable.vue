...
<template>
    <div class="flex">
        <aside id="sidebar-user"
            class="shadow-md w-64 h-screen transition-transform -translate-x-full sm:translate-x-0">
            <div
                ...
                <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <li>
                        <a href="#"
                            ...
                            <span class="ml-3">Licensing</span>
                        </a>
                    </li>
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap">Carrier Training</span>
                    ...
                    <li>
                        <a href="#"
                            ...
                            <span class="ml-3">Distributor Contact</span>
                        </a>
                    </li>
                </ul>
            </div>
