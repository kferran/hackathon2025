            ...
            <Transition mode="out-in" name="fade">
                <KeepAlive>
                    <Suspense>
                        ...
                        <template #fallback>
                            <div
                                class="flex items-center justify-center w-full h-56  rounded-lg dark:bg-gray-800 dark:border-gray-700">
                                <div role="status">
                                    <svg aria-hidden="true"
                                        class="w-1/2 h-1/2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
